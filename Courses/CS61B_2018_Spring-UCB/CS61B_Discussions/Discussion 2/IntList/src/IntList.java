...
public class IntList {
    ...
    public static void testSquare() {
        ...
        c.rest = new IntList(2, null);
        c.rest.rest = new IntList(3, null);
        IntList d = new IntList(1, null);
        d.rest = new IntList(2, null);
        d.rest.rest = new IntList(3, null);
        IntList e = new IntList(1, null);
        e.rest = new IntList(2, null);
        e.rest.rest = new IntList(3, null);

        IntList A = squareR(a);
        IntList B = squareI(b);
        IntList C = squareMutativeI(c);
        IntList D = squareMutativeR(d);
    }
